...
class Menu extends \yii\widgets\Menu
{
     ...
     */
    public $options = [
        'class' => 'nav nav-pills nav-sidebar flex-column nav-compact nav-legacy',
        'data-widget' => 'treeview',
        'role' => 'menu',
        'data-accordion' => 'false'
    ];
    public $activeCssClass = 'active text-bold';
    ...
    protected function renderItem($item)
    {
        ...
        return strtr($template, [
            ...
            '{url}' => $url,
            '{icon}' => $iconHtml,
            '{active}' => $item['active'] || $url == $_SERVER['REQUEST_URI'] ? $this->activeCssClass : '',
